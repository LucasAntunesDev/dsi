...
<body class="bg-slate-900 text-zinc-50">
    ...
    <div class="flex flex-col justify-center items-center gap-2">
        <div class="flex justify-around items-center gap-2">
            ...
            <a href="disciplina.php" class="bg-emerald-500 rounded-md py-1 px-4 focus:bg-slate-50
                ...
                <thead class="pl-6 font-semibold text-sm text-left pr-3 py-3.5 text-sky-500 bg-slate-800">
                    <tr class="table-row">
                        <th class="w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col"">
                            ...
                            <a <?php
                            echo (!isset($_GET['descrescente'])) ? "href='disciplinas.php?descrescente'" : "href='disciplinas.php'";
        ...
        <th class=" w-fit capitalize pl-2 pr-6 py-3 whitespace-nowrap" scope="col">Id do Professor</th>
        ...
        <tbody class=" text-sm bg-neutral-50/40">
            ...
            foreach ($disciplinas as $disciplina) {
                ...
                echo '<td class="pl-2 pr-1 w-fit">' . $disciplina->getProfessorId() . '</td>';
                echo '<td class="flex pl-2 pr-1 w-fit py-5 flex-nowrap gap-x-2" scope="col">';

                echo "<a href='disciplina.php?id=" . $disciplina->getId() . "' class='bg-emerald-500 rounded-full py-1 px-4 focus:bg-slate-50
                ...
                echo "<a href='excluirProfessor.php?id=" . $disciplina->getId() . "'  class='bg-red-500 rounded-full py-1 px-4 focus:bg-slate-50
